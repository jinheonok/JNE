...
public class UIScrollView : MonoBehaviour 
{
	...
	public void Start()
	{
		if (_prefab == null) 
		{
			JDebugger.Log ("UI Scroll View : Prefab is not allocated by user");
			return;
		}
	...
	public void RemoveContent(int idx)
	{
		...
		{
			JDebugger.Log ("RemoveContent parameter idx is out of range");
			return;
		}
	...
	public void RemoveContent(GameObject obj)
	{
		...
		JDebugger.Log ("RemoveContent can't find obj ");
	}
